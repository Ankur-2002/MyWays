...
const Header = ({ Tab, setTab }) => {
  ...
  const check = async () => {
    try {
      const data = await Fetch('/user/check', 'POST', { Token: Token });
      ...
      <Headers>
        ...
        <ButtonPanel>
          {!Token ? (
            ...
            <Profiler>
              <Circle src="https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_960_720.png" />
